...
<kbd style="background-color: white; color: white; cursor: pointer;" onclick="toggleConf('citeJQE21')"> Citation </kbd>
<span id="citeJQE21" class="panel" style="display: none; background-color: #F1F1F1; padding: 5px;text-align: justify; color: gray;">  
