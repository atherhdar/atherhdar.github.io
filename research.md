...
<kbd style="background-color: #9370D8; cursor: pointer;" onclick="toggleAbstract('abstract1')"> Abstract</kbd> 
...
with Debayan Pakrashi and Sounak Thakur <br>
<kbd style="background-color: #e0e0e0; cursor: pointer;" onclick="toggleAbstract('abstract2')"> Abstract </kbd> 
...
<kbd style="background-color: #e0e0e0; cursor: pointer;" onclick="toggleAbstract('abstract3')"> Abstract </kbd> 
