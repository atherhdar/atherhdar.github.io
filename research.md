...
with Debayan Pakrashi and Sounak Thakur <br>
<kbd style="background-color: #e0e0e0; cursor: pointer;" onclick="toggleAbstract()"> Abstract </kbd> 
<span id2="abstract-text" class="panel" style="display: none; background-color: #F1F1F1; padding: 5px;text-align: justify; color: #000000;">  
...
<kbd style="background-color: #e0e0e0; cursor: pointer;" onclick="toggleAbstract()"> Abstract </kbd> 
<span id3="abstract-text" class="panel" style="display: none; background-color: #F1F1F1; padding: 5px;text-align: justify; color: #000000;">  
