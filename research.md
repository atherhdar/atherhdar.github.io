...
<kbd style="background-color: #9370D8; color: white; cursor: pointer;" onclick="toggleAbstract('abstract1')"> Abstract</kbd> <kbd>style="background-color: #9370D8; color: white; cursor: pointer;" onclick="toggleAbstract('citation1')"> Citation </kbd> 
...
<span id="citation1" class="panel" style="display: none; background-color: #F1F1F1; padding: 5px;text-align: justify; color: #000000;">  
Dar, A. H., Mathur, S. K., & Mishra, S. (2021). The efficiency of Indian banks: A DEA, Malmquist and SFA analysis with bad output. Journal of Quantitative Economics, 19, 653-701.</span>
